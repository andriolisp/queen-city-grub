...
MuxController.handleHelpMenu = function (senderId, recipientId, payload) {
  if (senderId && recipientId) {
    ...
    if (location !== null && location != undefined) {
      ...
      MessengerController.sendText(senderId, "Opa!! vamos te ajudar a achar um lugar legal para comer ai perto, você pode me mandar sua localização?").then(function () {
        MuxService.handleRequest({
          "defaultLocation": defaultLocation,
          "message": payload,
          "userId": senderId,
