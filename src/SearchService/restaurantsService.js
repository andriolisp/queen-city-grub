    ...
    api.details({placeid: placeId}, function (err, res) {
      if (err || res.status !== 'OK') {
        ...
        resolve({
          ...
          'websiteLink': _.get(res, 'result.website', null),
          'bubbleLink': _.get(res, 'result.url', null),
...
RestaurantsService.find = function (request) {
  return new Promise(function (resolve) {
    ...
    var api = new GooglePlacesAPI('AIzaSyCKynz61ZWAZwl5eyclLQaIjtcOdg1aAk0')
    ...
    var searchCriteria = {
      'radius': 3000, // Look within 7 mile radius of location?
